      ...
      <div className='page-content'>
        <Container fluid={true}>
          ...
          <Row>
            <Col lg={4}>
              <Card>
                <CardHeader className='h4 bg-transparent border-bottom text-uppercase'>
                  Featured
                </CardHeader>
                <CardBody>
                  ...
                  <Col md={8}>
                    <CardBody>
                      ...
                      <CardText>
                        ...
                        natural lead-in to additional content. This is a wider
          ...
          <Row>
            <Col lg={4}>
              ...
              >
                <CardHeader className='bg-transparent'>
                  <h5 className='my-0 text-primary'>Header</h5>
                </CardHeader>
                <CardBody>
            ...
            <Col lg={4}>
              <Card
                outline
                color='danger'
                className='border card-border-danger'
              >
                <CardHeader className='bg-transparent'>
                  <h5 className='my-0 text-danger'>Header</h5>
                </CardHeader>
                <CardBody>
                  <CardTitle className='mt-0'>Primary card title</CardTitle>
                  <CardText>
            ...
            <Col lg={4}>
              <Card
                outline
                color='success'
                className='border card-border-success'
              >
                <CardHeader className='bg-transparent'>
                  <h5 className='my-0 text-success'>Header</h5>
                </CardHeader>
                <CardBody>
                  <CardTitle className='mt-0'>Primary card title</CardTitle>
                  <CardText>
